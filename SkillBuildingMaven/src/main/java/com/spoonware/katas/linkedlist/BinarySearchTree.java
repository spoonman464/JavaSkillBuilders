...
public class BinarySearchTree {
	/*
	 * Problem: given a tree, determine
	...
	// Spoon: this function came from Udemy 11 Interview Questions class
	// It looks like a super-crappy way to make a binary tree from a HashMap. It really
	// only works if the indexes used to create the 'mapping' HashMap have values that 
	// match the corresponding input values. mapping2 only works because the input indexes
	// are 3,1,4 in that order.
